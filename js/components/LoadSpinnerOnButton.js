...
function loading(buttonId) {
    ...
    <svg id="loading-svg" aria-hidden="true" role="status" class="inline my-auto w-6 h-6 me-3 text-violet-800 animate-spin" viewBox="0 0 100 101" fill="none" xmlns="http://www.w3.org/2000/svg">
